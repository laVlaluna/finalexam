...
public class AddPhoneActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhoneTitleEditText = findViewById(R.id.outcome_title_edit_text);
        mPhoneNumberEditText = findViewById(R.id.outcome_number_edit_text);
        mPhoneImageView = findViewById(R.id.phone_image_view);
        mSaveButton = findViewById(R.id.save_button2);

        // กำหนดให้ Activity เป็น Listener ของ ImageView
        mPhoneImageView.setImageResource(R.drawable.ic_expense);
    ...
    public void onClick(View view) {
        ...
        EditText eUser = findViewById(R.id.outcome_title_edit_text);
        EditText ePass = findViewById(R.id.outcome_number_edit_text);
        ...
        cv.put(lg.COL_NUMBERMINUS,sPass);
        ...
        Intent intent = new Intent(AddPhoneActivity2.this,MainActivity.class);
